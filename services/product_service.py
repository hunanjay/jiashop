...
def update_product(product, payload):
    for field in ("name", "description", "price", "stock", "status", "image_url", "main_images_json", "category", "customization_json", "sales_count", "specs", "variants_json", "images_json", "is_featured", "is_promotion"):
        if field in payload:
